  ...
  class pyramids extends NIN.THREENode {
    ...
    update(frame) {
      ...
      if (!this.camera.isOverriddenByFlyControls) {
        ...
        if (frame >= FRAME_FOR_BEAN(49*48)) {
          t = clamp(0, (frame - 6100) / (6322- 6100), 1);
          position.set(
            23.32,
            1.27,
            56.3
          ...
          quaternion.set(
          -0.1759380613473834, -0.39340048581942516, 0.025417587214663223, 0.9020176287559738
          );
        }
        ...
        if(frame >= 6322) {
          ...
          quaternion.set(
          -0.08596921078809892, -0.5220476945737982, -0.06013996483925947, 0.8464388247332387
          );
        }
