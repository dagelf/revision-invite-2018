  ...
  class pyramids extends NIN.THREENode {
    ...
    update(frame) {
      ...
      if (!this.camera.isOverriddenByFlyControls) {
        ...
        t = clamp(0, (frame - 5759) / (6100 - 5759), 1);
        position.set(
          13.6,
          lerp(-0.67, 0.43, t),
          70.27
        ...
        quaternion.set(
          -0.06543805591470453, 0.08189545980818294, -0.010461375780252451, 0.9944352940828753
        );

        if (frame >= FRAME_FOR_BEAN(50*48)) {
          t = clamp(0, (frame - FRAME_FOR_BEAN(50*48)) / (6573- FRAME_FOR_BEAN(50*48)), 1);
          position.set(
            105,
            49,
            52
          ...
          quaternion.set(
          -0.48946855563830977,-0.48714703870264797, -0.5149782137163068, 0.5078442035921542
          );
        }
        ...
        if (frame >= 6573) {
          ...
          quaternion.set(
            -0.12510391195222598, 0.927266308631825, 0.12529095875866367, 0.32989146661272317
          );
        }
